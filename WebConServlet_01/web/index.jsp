    ...
    <body>
        ...
        <form class="form-table" method = "POST" action="ServletDatos">
            <fieldset>
                ...
                <div class="fila">
                    ...
                    <div class="celda">
                        <div class="celda" style="width: 90px">
                            <input type="checkbox" name="deportes" value="Football">Football<br>
                            <input type="checkbox" name="deportes" value="Karate">Karate
                        </div>
                        <div class="celda">
                ...
                <div class="fila">
                    <label class ="celda" style="width: 80px">Pasatiempos</label>
                    <div class="celda">
                        <select name="pasatiempos" style="width: 180px" size="4" multiple>
                            <option value="Jugar Ajedres">Jugar Ajedrez</option>
                            <option value="Juegos de Pinball">Juegos de Pinball</option>
                            <option value="Algo de Cocina">Juegos de Cocina</option>
                            <option value="Ver Peliculas">Ver Peliculas</option>
                            <option value="Lecturas Variadas">Lecturas Variadas</option>
